...
Tokens are used for authentication. A token is passed from the server to allow access to certain features of the app.

- [ x] What steps can you take in your web apps to keep your data secure?

A private route can be used to secure parts of the web app which can only be accessed with an authentication token.

- [x ] Describe how web servers work.

A server can refer to the physical computer which stores data that is then transmitted to a website, or to the file with the code from which the website submits and retrieves data.

- [ x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Put, is the U in CRUD, which stands for update. It is used to make updates to data in the server. Delete is the D in CRUD. It is used to remove, or destroy data on the server.
